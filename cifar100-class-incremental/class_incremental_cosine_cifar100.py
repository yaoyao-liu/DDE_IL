...
from utils_incremental.incremental_train_and_eval_d_constrain import incremental_train_and_eval_d_constrain
from utils_incremental.incremental_train_and_eval_MS import incremental_train_and_eval_MS
from utils_incremental.incremental_train_and_eval_MS_TDE import incremental_train_and_eval_MS_TDE
...
parser.add_argument('--TDE', action='store_true', \
