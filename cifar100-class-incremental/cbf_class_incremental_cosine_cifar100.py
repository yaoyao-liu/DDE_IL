...
for iteration_total in range(args.nb_runs):
    ...
    for iteration in range(start_iter, int(args.num_classes/args.nb_cl)):
        ...
        if iteration > start_iter and args.cb_finetune:
            ...
            torch.save(tg_model, ckp_path+'/run_{}_iteration_{}_CBF_model.pth'.format(iteration_total, iteration))
            class_means_name = ckp_path+'/run_{}_iteration_{}_CBF_class_means.pth'.format(iteration_total, iteration)
